...
export default function Dashboard() {
    ...
    // Static data based on your seeders
    const stats = {
        totalDoctors: 100, // 10 specializations × 10 doctors each (5 private + 5 government)
        totalPatients: 1, // From your UserSeeder
        totalAppointments: 1000, // 100 doctors × 10 appointments each
        bookedAppointments: 2, // From your BookedAppointmentSeeders
        facilities: 20, // From your FacilitySeeder
    };
    ...
    useEffect(() => {
        var optionsProfileVisit = {
            ...
            series: [{
                name: 'Appointments',
                data: [80, 120, 90, 110, 100, 130, 150, 140, 120, 110, 100, 90]
            }],
            colors: '#435ebe',
            xaxis: {
                categories: ["Jan","Feb","Mar","Apr","May","Jun","Jul", "Aug","Sep","Oct","Nov","Dec"],
        ...
        let optionsVisitorsProfile  = {
            series: [stats.totalDoctors, stats.totalPatients],
                ...
                <div className="col-12 col-lg-9">
                            ...
                            <div className="card">
                                <div className="card-body px-3 py-4-5">
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            <h6 className="text-muted font-semibold">Total Doctors</h6>
                                            <h6 className="font-extrabold mb-0">{stats.totalDoctors}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div className="card-body px-3 py-4-5">
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            ...
                                            <h6 className="font-extrabold mb-0">{stats.totalPatients}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                <div className="card-body px-3 py-4-5">
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            <h6 className="text-muted font-semibold">Appointments</h6>
                                            <h6 className="font-extrabold mb-0">{stats.totalAppointments}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="card">
                                <div className="card-body px-3 py-4-5">
                                    <div className="row">
                                        ...
                                        <div className="col-md-8">
                                            <h6 className="text-muted font-semibold">Booked Appointments</h6>
                                            <h6 className="font-extrabold mb-0">{stats.bookedAppointments}</h6>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className="row">
                        <div className="col-12 col-xl-4">
                            <div className="card">
                            <div className="card-header">
                                <h4>Facilities Distribution</h4>
                            </div>
                            <div className="card-body">
                                {[
                                { region: "Private", visits: 12, chartId: "chart-europe", color: "text-primary" },
                                { region: "Government", visits: 8, chartId: "chart-america", color: "text-success" },
                                ].map((item, index) => (
                                <div className="row" key={index}>
                                    <div className="col-6">
                                    <div className="d-flex align-items-center">
                                ...
                                <table className="table table-hover table-lg">
                                    ...
                                    {[
                                        { 
                                            ...
                                            status: "confirmed",
                                            img: "admin/assets/images/faces/5.jpg" 
                                        },
                                        { 
                                            name: "Jane Smith", 
                                            appointment: "General Checkup 2", 
                                            status: "confirmed",
                                            img: "admin/assets/images/faces/5.jpg" 
                                        }
                                        ...
                                        <td className="col-3">
                                            ...
                                            <p className="font-bold ms-3 mb-0">{appointment.name}</p>
                                            </div>
                                        </td>
                                        <td className="col-auto">
                                            <p className="mb-0">{appointment.appointment}</p>
                                        </td>
                                        <td className="col-auto">
                ...
                <div className="col-12 col-lg-3">
                    <div className="card">
                        <div className="card-body py-4 px-5">
                            <div className="d-flex align-items-center">
                                <div className="avatar avatar-xl">
                                    <img src="admin/assets/images/faces/1.jpg" alt="Admin" />
                                </div>
                                <div className="ms-3 name">
                                    <h5 className="font-bold">Admin User</h5>
                                    <h6 className="text-muted mb-0">Administrator</h6>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className="card">
                        ...
                        <div className="card-content pb-4">
                            <div className="px-4 py-3">
                                <h6 className="text-muted">Facilities</h6>
                                <h5 className="font-bold">{stats.facilities}</h5>
                            </div>
                            <div className="px-4 py-3">
                                <h6 className="text-muted">Booked Appointments</h6>
                                <h5 className="font-bold">{stats.bookedAppointments}/{stats.totalAppointments}</h5>
                            </div>
                            <div className="px-4 py-3">
                                <h6 className="text-muted">Patient Ratio</h6>
                                <h5 className="font-bold">1:{stats.totalDoctors}</h5>
                            </div>
                        </div>
                    </div>
                    <div className="card">
